...
void Frame::Write(char c, int x, int y, RGBColor fg, RGBColor bg)
{
  Write(&c, 1, x, y, fg, bg);
}
...
void Frame::Write(const char *buf, int size, int x, int y, RGBColor fg, RGBColor bg)
{
...
void Frame::AddBorder(RGBColor fg, RGBColor bg)
{
